...
extern void *mono_aot_module_NetworkTest_iOS_info;
...
extern void *mono_aot_module_NetworkTest_info;
...
{
	mono_aot_register_module (mono_aot_module_NetworkTest_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_NetworkTest_info);
...
void xamarin_setup ()
{
	...
	xamarin_executable_name = "NetworkTest.iOS.exe";
